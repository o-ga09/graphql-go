...
type ComplexityRoot struct {
	...
	Query struct {
		NoteByID func(childComplexity int, input string) int
		Notes    func(childComplexity int, input string) int
		UserByID func(childComplexity int, input string) int
...
type QueryResolver interface {
	Notes(ctx context.Context, input string) ([]*model.Note, error)
	Users(ctx context.Context) ([]*model.User, error)
	NoteByID(ctx context.Context, input string) (*model.Note, error)
	UserByID(ctx context.Context, input string) (*model.User, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Query.noteById":
		...
		return e.complexity.Query.NoteByID(childComplexity, args["input"].(string)), true
	...
	case "Query.notes":
		...
		return e.complexity.Query.Notes(childComplexity, args["input"].(string)), true
	...
	case "Query.userById":
		...
		return e.complexity.Query.UserByID(childComplexity, args["input"].(string)), true
...
func (ec *executionContext) _Query_noteById(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_Query_noteById(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().NoteByID(rctx, fc.Args["input"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) fieldContext_Query_noteById(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Query",
		Field:      field,
		IsMethod:   true,
	...
	ctx = graphql.WithFieldContext(ctx, fc)
	if fc.Args, err = ec.field_Query_noteById_args(ctx, field.ArgumentMap(ec.Variables)); err != nil {
		ec.Error(ctx, err)
		return fc, err
	}
	return fc, nil
...
func (ec *executionContext) _Query_userById(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().UserByID(rctx, fc.Args["input"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
